...
""",
    ...
    def test_new_intake_is_immediately_visible_and_home_shows_version(self) -> None:
        ...
        page = self.client.get("/")
        self.assertEqual(page.text.count("SYSTEM V1.0-Alpha.34"), 1)
    ...
    def test_project_menu_is_hidden_from_project_manager(self) -> None:
        ...
        self.assertIn("editorial-ui.css?v=1.0-Alpha.34-login", login_page.text)
        self.assertIn("autodev-sidebar-mark.png?v=1.0-Alpha.34", login_page.text)
        ...
        self.assertEqual(pm_page.text.count("SYSTEM V1.0-Alpha.34"), 1)

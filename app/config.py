...
class Settings:
    ...
    runner_version: str = os.getenv("AUTODEV_RUNNER_VERSION", "1.0-Alpha.25").strip() or "1.0-Alpha.25"
    ...
    max_artifact_mb: int = max(1, int(os.getenv("AUTODEV_MAX_ARTIFACT_MB", "1024")))
